/**
 * =============================================================
 * Stilly Run 'N Gun — Google Apps Script (v129)
 *
      ...
      for (var ex = 0; ex < existData.length; ex++) {
        ...
        for (var b = 0; b < 50; b++) {
          ...
          if (isRunTime) {
            ...
            exScores.push({
              time: firstVal,
              charlies: existData[ex][off + 1] || 0,
              deltas: existData[ex][off + 2] || 0,
              mikes: existData[ex][off + 3] || 0,
      ...
      for (var p2 = 0; p2 < shooters.length; p2++) {
        ...
        for (var s2 = 0; s2 < stageNames.length; s2++) {
          ...
          if (entry && entry.time !== 'DNF' && typeof entry.time === 'number' && entry.time > 0) {
            ...
            } else if (inf2.type === 'run_time' || inf2.targets <= 0) {
